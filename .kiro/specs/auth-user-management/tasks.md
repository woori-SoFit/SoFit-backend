...
- [ ] 1. Phase 1: 공통 인프라 — User 엔티티 확장, UserRole 수정, Redis 세션 설정, SecurityConfig [SOFIT-20]
  ...
  - [-] 1.2 RegistrationProcess 엔티티 신규 생성 및 RegistrationStep enum 생성
  ...
  - [ ] 1.3 Redis 세션 설정 (RedisSessionConfig)
  ...
  - [ ] 1.4 SessionValidationFilter 생성 (절대 만료 12시간)
  ...
  - [ ] 1.5 SecurityConfig 수정 (역할 기반 접근 제어)
  ...
  - [ ] 1.6 AuthErrorCode / AuthSuccessCode 확장
...
- [ ] 3. Phase 2: 로그인 [SOFIT-20]
  ...
  - [ ] 3.1 LoginRequest / LoginResponse DTO 생성
  ...
  - [ ] 3.2 AuthService 인터페이스에 login 메서드 추가 및 구현
