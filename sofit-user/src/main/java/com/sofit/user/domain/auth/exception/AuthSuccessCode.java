...
public enum AuthSuccessCode implements BaseSuccessCode {
    ...
    PIN_VERIFIED(HttpStatus.OK, "AUTH2002", "금융인증서 본인인증에 성공했습니다."),
    SIGNUP_COMPLETED(HttpStatus.CREATED, "AUTH2003", "회원가입이 완료되었습니다."),
    LOGIN_ID_CHECKED(HttpStatus.OK, "AUTH2007", "아이디 중복 확인이 완료되었습니다."),
    CERT_LOOKUP_SUCCESS(HttpStatus.OK, "AUTH2008", "금융인증서 조회에 성공했습니다."),
