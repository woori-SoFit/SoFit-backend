...
public enum LoanSuccessCode implements BaseSuccessCode {
    ...
    LOAN_STEP_AUTH_OK(HttpStatus.OK, "LOAN2014", "본인인증이 완료되었습니다."),
    LOAN_STEP_BIZ_INFO_OK(HttpStatus.OK, "LOAN2015", "사업자 정보 확인이 완료되었습니다."),
    LOAN_STEP_MYDATA_OK(HttpStatus.OK, "LOAN2016", "마이데이터 약관 동의가 완료되었습니다.");
