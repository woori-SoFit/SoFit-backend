...
INSERT INTO my_biz_data (
    business_number, industry_code, industry_name, district_code,
...
('1012345678', 'I56111', '음식점업(분식)',    'SEOUL-GN',    '2026-05-01', 36, 240000000, 21000000, 19500000, 7.69,  21000000.00, 820, 25609.76,  1, 3,  23000000, 18500000, 42000000, 5200000, 4500000, 7800000, 340, 4.6, 38.50, 92.00, 6,  4.7, 510, 88.20, 18.50, 21.30, 25.00, 'FILED', '2026-05-10', false, 'PAID', 5, true,  true,  true,  NOW(), NOW()),
('1023456789', 'I56192', '비알코올음료점업', 'SEOUL-MP',    '2026-05-01', 18, 132000000, 11500000, 10800000, 6.48,  11500000.00, 640, 17968.75,  2, 5,  12800000, 9900000,  18500000, 3100000, 2900000, 4200000, 210, 4.5, 42.00, 89.00, 8,  4.6, 380, 85.40, 32.00, 35.50, 40.20, 'FILED', '2026-05-11', false, 'PAID', 3, true,  true,  true,  NOW(), NOW()),
('1034567890', 'I56111', '음식점업(한식)',    'SEOUL-SD',    '2026-05-01', 24, 180000000, 15800000, 14900000, 6.04,  15800000.00, 530, 29811.32,  1, 4,  17100000, 13200000, 27000000, 4300000, 3900000, 0,       0,   NULL, 55.00, 95.00, 12, 4.4, 240, 82.10, 24.50, 29.00, 31.20, 'FILED', '2026-05-09', false, 'PAID', 4, true,  false, false, NOW(), NOW()),
('1045678901', 'I56192', '비알코올음료점업', 'SEOUL-JR',    '2026-05-01', 12, 96000000,  7800000,  8300000,  -6.02, 7800000.00,  410, 19024.39,  4, 8,  8200000,  7600000,  9200000,  1600000, 600000,  2900000, 160, 4.1, 24.00, 71.00, 3,  4.2, 170, 73.50, 58.00, 61.20, 64.00, 'FILED', '2026-05-12', false, 'PAID', 2, true,  false, true,  NOW(), NOW()),
('1056789012', 'I55101', '숙박업',           'SEOUL-SC',    '2026-05-01', 48, 150000000, 12400000, 11800000, 5.08,  12400000.00, 360, 34444.44,  1, 3,  13600000, 10100000, 31000000, 4100000, 3500000, 0,       0,   NULL, 31.00, 88.00, 5,  4.8, 290, 91.30, 28.00, 24.00, 22.50, 'FILED', '2026-05-08', false, 'PAID', 3, true,  true,  true,  NOW(), NOW()),
('1067890123', 'I56192', '비알코올음료점업', 'GYEONGGI-SN', '2026-05-01', 30, 210000000, 18800000, 17600000, 6.82,  18800000.00, 760, 24736.84,  1, 4,  20100000, 16200000, 24500000, 4700000, 3900000, 9600000, 430, 4.4, 36.00, 84.00, 4,  4.5, 420, 84.70, 22.00, 27.50, 34.00, 'FILED', '2026-05-10', false, 'PAID', 4, true,  true,  false, NOW(), NOW()),
('1078901234', 'I56221', '음식점업(치킨)',    'SEOUL-DDM',   '2026-05-01', 60, 168000000, 13200000, 14100000, -6.38, 13200000.00, 290, 45517.24,  3, 9,  14000000, 12500000, 36000000, 3300000, 1500000, 0,       0,   NULL, 27.00, 78.00, 2,  4.3, 130, 76.40, 41.00, 39.50, 36.00, 'FILED', '2026-05-13', false, 'PAID', 2, true,  false, true,  NOW(), NOW()),
('1089012345', 'I56192', '비알코올음료점업', 'SEOUL-YD',    '2026-05-01', 42, 192000000, 16700000, 15100000, 10.60, 16700000.00, 590, 28305.08,  1, 2,  18100000, 13900000, 41000000, 5100000, 4200000, 3100000, 120, 4.7, 33.00, 90.00, 7,  4.8, 360, 89.60, 20.00, 19.00, 21.50, 'FILED', '2026-05-09', false, 'PAID', 6, true,  true,  true,  NOW(), NOW()),
('1090123456', 'I56111', '음식점업(한식)',    'SEOUL-GD',    '2026-05-01', 15, 108000000, 9200000,  8100000,  13.58, 9200000.00,  95,  96842.11,  5, 12, 10100000, 6900000,  15000000, 3600000, 3200000, 0,       0,   NULL, 18.00, 83.00, 10, 4.6, 75,  86.00, 36.00, 30.50, 38.00, 'FILED', '2026-05-14', false, 'PAID', 1, true,  false, false, NOW(), NOW()),
('1101234567', 'I56111', '음식점업(한식)',    'SEOUL-NW',    '2026-05-01', 72, 264000000, 22600000, 21400000, 5.61,  22600000.00, 410, 55121.95,  1, 3,  23800000, 18100000, 58000000, 7900000, 5700000, 0,       0,   NULL, 22.00, 87.00, 6,  4.7, 220, 88.90, 16.00, 15.50, 18.00, 'FILED', '2026-05-07', false, 'PAID', 8, true,  true,  true,  NOW(), NOW());


-- business_number='1012345678' (음식점업 분식, SEOUL-GN) 추가 5개월치
-- 2025-12 ~ 2026-04, 5월 데이터(monthly_revenue=21,000,000)로 역산한 완만한 성장 추세
INSERT INTO my_biz_data (business_number, industry_code, industry_name, district_code, reference_month, business_age_months, annual_income, monthly_revenue, prev_month_revenue, monthly_revenue_growth_rate, monthly_transaction_amount, monthly_transaction_count, avg_transaction_amount, days_since_last_transaction, max_inactive_days, monthly_inflow, monthly_outflow, account_balance, estimated_profit, cash_flow, delivery_sales_amount, delivery_order_count, delivery_rating, online_reorder_rate, online_reply_rate, online_info_update_count, review_rating, review_count, positive_review_ratio, industry_sales_rank, industry_profit_rank, industry_stability_rank, vat_filing_status, vat_filing_date, tax_overdue, insurance_payment_status, employee_count, has_sns, has_online_reservation, is_near_subway, created_at, updated_at) VALUES
('1012345678', 'I56111', '음식점업(분식)', 'SEOUL-GN', '2025-12-01', 31, 240000000, 16800000, 16200000, 3.70, 16800000.00, 710, 23661.97, 1, 3, 18200000, 15100000, 42000000, 4100000, 3500000, 6100000, 270, 4.5, 35.00, 88.00, 4, 4.6, 440, 86.10, 22.50, 25.00, 28.00, 'FILED', '2025-12-10', false, 'PAID', 5, true, true, true, NOW(), NOW()),
('1012345678', 'I56111', '음식점업(분식)', 'SEOUL-GN', '2026-01-01', 32, 240000000, 17400000, 16800000, 3.57, 17400000.00, 730, 23835.62, 1, 3, 18900000, 15600000, 42000000, 4300000, 3700000, 6400000, 285, 4.5, 36.00, 89.00, 5, 4.6, 460, 86.50, 21.50, 24.00, 27.00, 'FILED', '2026-01-10', false, 'PAID', 5, true, true, true, NOW(), NOW()),
('1012345678', 'I56111', '음식점업(분식)', 'SEOUL-GN', '2026-02-01', 33, 240000000, 18100000, 17400000, 4.02, 18100000.00, 755, 23973.51, 1, 3, 19600000, 16100000, 42000000, 4500000, 3900000, 6700000, 300, 4.6, 36.50, 90.00, 5, 4.7, 475, 87.00, 21.00, 23.00, 26.50, 'FILED', '2026-02-10', false, 'PAID', 5, true, true, true, NOW(), NOW()),
('1012345678', 'I56111', '음식점업(분식)', 'SEOUL-GN', '2026-03-01', 34, 240000000, 19000000, 18100000, 4.97, 19000000.00, 780, 24358.97, 1, 3, 20500000, 17000000, 42000000, 4700000, 4100000, 7100000, 315, 4.6, 37.00, 91.00, 6, 4.7, 490, 87.50, 20.00, 22.00, 25.50, 'FILED', '2026-03-10', false, 'PAID', 5, true, true, true, NOW(), NOW()),
('1012345678', 'I56111', '음식점업(분식)', 'SEOUL-GN', '2026-04-01', 35, 240000000, 19500000, 19000000, 2.63, 19500000.00, 800, 24375.00, 1, 3, 21200000, 17800000, 42000000, 4900000, 4200000, 7400000, 328, 4.6, 37.50, 91.00, 6, 4.7, 500, 87.80, 19.50, 21.50, 25.00, 'FILED', '2026-04-10', false, 'PAID', 5, true, true, true, NOW(), NOW());
